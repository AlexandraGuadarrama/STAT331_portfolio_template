...
# Lab 5, Find who hired the initial suspect
...
```{r}
#| label: wd-3-string
# Lab 5, Find interviews from two witnesses
person |>
...
```{r}
#| label: wd-3-date
# Lab 5, Access report from date of murder
crime_scene_report |>
...
# Revision: Instead of nesting everything, I separated them so the code is
...
# Lab 5, Find initial suspect based on witness interviews
...
# Modified Lab 5 code using an anti_join to pull names of
...
# Also, moved arrange() function before applying pivot_wider()
...
# Final Revision: adjusted previous code for "region" using fct_reorder2()
# function, as opposed to reordering legend manually 
...
```{r}
#| label: dvs-3-2
# Challenge 4, Analysis Question 2
...
ggplot(data = county_data_summary, 
       mapping = aes(x = county_name, 
                     ...
                     fill = county_name)) +
      geom_col() +
      geom_text(aes(label = round(mean_cost), 
                    y = mean_cost + 10),
...
fish |>
  ...
  kable(caption = "Number of Missing Values in Fish Dataset",
...
Throughout the course, I've revised my thinking in different ways. For example, I struggled with my YAML set up for some time, which resulted in "incomplete" submissions. After understanding what was going wrong and how it's had impacted the visual aspect of my quarto documents, I've been able to create cleaner and more professional documents. I've also made sure to be mindful about my code formatting (e.g. "stay consistent and always surround your = signs with blank spaces") so the code flows better and is easy to interpret. In my midterm and final portfolio's, I've noted some changes I made based on feedback, and whether they were marked "growing" or "success" in the lab rubric. I also made sure to comment on any additions or edits I made to my previous code in order to fit the course criteria (e.g. WD-6, WD-2, PE-4).

## Extending My Thinking

To extend my thinking, I always take what I learn from programming activities or constructive feedback from previous labs and apply those to future assignments. In fact, in one of my other classes this quarter, I've been using what I learned about tidy code and quarto documents in my lab work. This helps me share R code more effectively with my classmates in a way that's easy to view. I've also revised most of my lab assignments to correct any "growing" comments I received, which helps me figure out what I've done wrong and how to improve my code for the next lab assignment. Throughout the course, I've used online resources, like Google, ChatGPT, and YouTube videos to get a better understanding how certain R functions work and how they connect to each other. For example, I'll often scroll through Google to find any cheat sheets that consolidate some of the code we've learned in class, and save those to reference later. The Help tab in R studio has also been a great tool because it provides a variety of aliases and examples that I can just click through and determine which function would fit best in my assignment.
