...
# Revision: I manually created colors initally, but to make it more color friendly I used a template the viridis R package instead
ggplot(data = surveys, 
       mapping = aes(x = species, 
                     y = weight, 
                     color = sex)) + 
...
#| label: dvs-2-ex-5
# Lab 4, Question 7
# I strongly recommend against nested functions, as they are difficult for people to understand what your code is doing. 
...
#| label: dvs-3-1-ex-1
# Lab 3 Challenge
# I would encourage you to push yourself a bit more and try and recreate more of my plot. 
