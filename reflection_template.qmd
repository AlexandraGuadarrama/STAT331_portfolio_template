...
# Lab 5
# This would keep all potential_suspect rows and add interview data where there's a match
...
# This would keep all interview rows and add potential_suspect data where there's a match
final_suspect <- potential_suspect |>
...
# Originally did not have geom_text or currency label
...
<!-- For the revisions included in your Portfolio, to help me understand the nature of your revisions, please denote somehow the feedback I provided you (e.g., boldface, italics, colored text) before your revisions. (couple paragraphs (7-8 sentences)) -->
